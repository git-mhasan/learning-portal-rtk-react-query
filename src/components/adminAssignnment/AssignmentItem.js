...
import { useDeteleAssignmentMutation } from '../../features/assignment/assignmentApi';

const AssignmentItem = ({ assignment }) => {
    const { id, title, video_id, video_title, totalMark } = assignment || {};
    const [deteleAssignment, { isLoading }] = useDeteleAssignmentMutation();
    ...
    return (
        <tr>
            ...
            <td className="table-td">{video_title?.slice(0, 70)}</td>
